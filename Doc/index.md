...
- [Arithmetic](basics/arithmetic.md)
- [Conditional expressions](basics/conditionals.md)
...
- [builtins](basics/builtins_list.md) (regroup all builtins defined in this doc)
- [global confituration](basics/configuration.md)

## Advanced :

- [Module](advanced/module.md)
- [execution flow control](advanced/execution_flow.md)
- [compilation](advanced/compilation.md)
- [syscall](advanced/syscalls.md)
- [grammar extension](advanced/grammar_extension.md)
...
- [prompt](repl/prompt.md)
- [key binding](repl/key_binding.md)
- [repl hooks](repl/hooks.md)

## script specific :

- [execution flow control](script/execution_control.md)
