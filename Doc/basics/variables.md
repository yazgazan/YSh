...
- if functions are concidered first-class citizen, lambdas ? Also, how should functions translate when converted to string ? error ?
...
numeric strings (such as "0") will be considered as a numeric 0 when needed.
